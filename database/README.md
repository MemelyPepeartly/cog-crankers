...
1. Run `database/sql/001_create_cogslop.sql` in SQL Server Management Studio or Azure Data Studio.
2. Update the API connection string (`apps/api/CogSlop.Api/appsettings*.json`).
